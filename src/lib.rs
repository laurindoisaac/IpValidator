...
#[derive(Debug)]
pub struct IpValidatorProcessor {
    verbose: bool,
    processed_count: usize,
}

impl IpValidatorProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting IpValidator processing");
    
    let mut processor = IpValidatorProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = IpValidatorProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = IpValidatorProcessor::new(false);
